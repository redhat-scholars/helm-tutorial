...
:tutorial-url: https://github.com/redhat-developer-demos/rhd-tutorial-helm.git
:folder: my_folder
include::https://raw.githubusercontent.com/redhat-developer-demos/rhd-tutorial-helm/master/download-sources.adoc[]